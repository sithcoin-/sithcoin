...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Sithcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Sithcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1  * 24 * 60 * 60 * 7; // Sithcoin: every week
static const int64 nTargetSpacing = 60 * 15; // Sithcoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Sithcoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Sithcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Sithcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4d0e7e26d9466caa4013a7c3440c7dc992a92298f63c518dd9e3ce50ff30235a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The empire invades the planet of Hoth, to squash the rebel scum.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xb9c3f5f8ab1a2c8ef49f13f658f848c9c85a1f3a689999fc17e7da0a2a930293"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Sithcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
